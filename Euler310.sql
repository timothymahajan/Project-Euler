...
case when [6] > 0 then 1 else 0 end +
...
case when [13] > 0 then 1 else 0 end +
case when [14] > 0 then 1 else 0 end +
case when [15] > 0 then 1 else 0 end +
case when [16] > 0 then 1 else 0 end +
case when [17] > 0 then 1 else 0 end +
case when [18] > 0 then 1 else 0 end +
case when [19] > 0 then 1 else 0 end +
case when [20] > 0 then 1 else 0 end +
case when [21] > 0 then 1 else 0 end +
case when [22] > 0 then 1 else 0 end +
case when [23] > 0 then 1 else 0 end +
case when [24] > 0 then 1 else 0 end +
case when [25] > 0 then 1 else 0 end +
case when [26] > 0 then 1 else 0 end + 
case when [27] > 0 then 1 else 0 end + 
case when [28] > 0 then 1 else 0 end + 
case when [29] > 0 then 1 else 0 end as num_moves
from squares_combinations
),
odd as 
(
select * from pile where num_moves%2 = 1
),
even as 
(
select * from pile where num_moves%2 = 0
),  
pile_num as
(
select ROW_NUMBER() over(order by a, b, c) as rn, a, b, c from piles
)
select * from pile_num
left outer join pile sc1 on a=sc1.sm
order by rn
...
--select * from num
--left outer join squares_combinations sc1 on num=sc1.sm
